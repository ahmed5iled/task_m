                        ...
                        <div class="card card-custom gutter-b ">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea name="short_description" id="description"
                                                      ...
                                                      placeholder="Please enter short description">{{$product->short_description??old('short_description')}}</textarea>
                                            <span
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea name="long_description" id="description_2"
                                                      ...
                                                      placeholder="Please enter long description">{{$product->long_description??old('long_description')}}</textarea>
                                            <span
                                            ...
                                            <select name="brand_id"
                                                ...
                                                @if($brands->count())
                                                    ...
                                                    @foreach($brands as $brand)
                                                        <option
                                                            value="{{$brand->id}}" {{$brand->id==$product->brand_id?'selected':null}}>
                                                            {{$brand->name??'-'}}
                                                        </option>
                                                    @endforeach
                                                @endif
                                    ...
                                    <div class="col-md-2">
                                        <img src="{{Storage::url($product->image)}}" style="width: 100px">
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-check">
                                            <input class="form-check-input" name="new_arrival" type="checkbox"
                                                   value="yes"
                                                   {{$product->new_arrival=='yes'?'checked':null}}
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" value="yes"
                                                ...
                                                {{$product->most_view=='yes'?'checked':null}}>
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" name="offer" type="checkbox"
                                                   value="yes"
                                                   {{$product->offer=='yes'?'checked':null}}
