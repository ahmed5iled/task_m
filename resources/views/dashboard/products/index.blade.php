...
@section('content')
    ...
    @include('dashboard.includes.delete-modal',['action_message' =>'This product'])
    ...
    <script>
        $(document).ready(function () {
            ...
            var table1 = $('#kt_datatable').DataTable({
                ...
                order: [[0, "desc"]],
                ajax: {
                    url: '{{ route('dashboard.products.show') }}',
                },
                columns: [
                    ...
                    {data: 'quantity', name: 'quantity', defaultContent: '-'},
            ...
            $('#name_en_input,#sku_input,#price_input,#date_from_input').keyup(function () {
                table1.draw();
            });
            $('#date_from_input').change(function () {
                table1.draw();
            });
        });
