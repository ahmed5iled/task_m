                ...
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                    <li class="breadcrumb-item">
                        <a href="{{route('dashboard.sliders.create')}}"
                           class="text-muted">Created New</a>
                    </li>
                </ul>
            </div>
            <!--end::Info-->
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card card-custom gutter-b ">
                        ...
                        <form class=" " action="{{ route('dashboard.sliders.store') }}"
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group m-form__group">
                                            ...
                                            <input type="text" value="{{ old('link') }}"
                                                   ...
                                                   id="link" name="link"
                                                   aria-describedby="emailHelp" placeholder="Please enter link ">
                                            @if ($errors->has('link'))
                                                <span class="m-form__help text-danger">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group m-form__group">
                                            ...
                                            <input type="file" name="image"
                                                   ...
                                                   id="image"
                                                   aria-describedby="emailHelp" placeholder="Please enter Image">
                                            @if ($errors->has('image'))
                                                <span class="m-form__help text-danger">
