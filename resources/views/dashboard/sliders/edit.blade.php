    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                <!--begin::Page Title-->
                <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Sliders</h5>
                <!--end::Page Title-->
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card card-custom gutter-b ">
                        <!--begin::Form-->
                        <form class=" "
                              action="{{ route('dashboard.sliders.update',['slider'=>$slider->id]) }}"
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-2">
                                        <img src="{{Storage::url($slider->image)}}" style="width: 100px;height: 100px;">
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="form-group m-form__group">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group m-form__group">
                                            ...
                                            <input type="text" value="{{ $slider->link??old('link') }}"
                                                   class="form-control m-input {{ $errors->has('link') ? 'is-invalid' : '' }}"
                                                   id="link" name="link"
                                                   aria-describedby="emailHelp" placeholder="Please enter اللينك ">
                                            @if ($errors->has('link'))
                                                <span class="m-form__help text-danger">
