...
<i class="menu-text_icon fas fa-home"></i>
                                            <!--end::Svg Icon-->
										</span>
...
<i class="menu-text_icon fas fa-list-alt"></i>
                                                </span>
                                            <!--end::Svg Icon-->
										</span>
                    ...
                    <a href="{{route('dashboard.products.index')}}"
                       class="menu-link">
										<span class="svg-icon menu-icon">
											<!--begin::Svg Icon | path:assets/media/svg/icons/Design/Layers.svg-->
											<span class="svg-icon svg-icon-primary svg-icon-2x">
                                            <i class="menu-text_icon fab fa-product-hunt"></i>
                                            </span>
                                            <!--end::Svg Icon-->
										</span>
                    ...
                    <a href="{{route('dashboard.sliders.index')}}"
                       class="menu-link">
										<span class="svg-icon menu-icon">
											<!--begin::Svg Icon | path:assets/media/svg/icons/Design/Layers.svg-->
											<span class="svg-icon svg-icon-primary svg-icon-2x">
<i class="menu-text_icon fas fa-image"></i>
                                            </span>
                                            <!--end::Svg Icon-->
										</span>
                ...
                <li class="menu-item {{ request()->is('*/brands*') ? 'menu-item-active' : '' }}"
                    aria-haspopup="true">
                    <a href="{{route('dashboard.brands.index')}}"
                       class="menu-link">
										<span class="svg-icon menu-icon">
											<!--begin::Svg Icon | path:assets/media/svg/icons/Design/Layers.svg-->
											<span class="svg-icon svg-icon-primary svg-icon-2x">
<i class="menu-text_icon fas fa-file"></i>
                                            </span>
                                            <!--end::Svg Icon-->
										</span>
